Pod::Spec.new do |spec|
  ...
  spec.source       =  {
    git: 'https://github.com/DanCodez/cocos2d-swift.git',
    tag: 'release-3.1.2',
    :submodules => true
  }
  ...
  spec.subspec 'ObjectiveChipmunk' do |sp|
    ...
    sp.source_files = 'external/Chipmunk/include/**/*.h',
    ...
    search_paths = %w( "$(PODS_ROOT)/Headers/Public/cocos2d-swift/Chipmunk/include"
                       "$(PODS_ROOT)/Headers/Public/cocos2d-swift/Chipmunk/objectivec/include"   
                      )
